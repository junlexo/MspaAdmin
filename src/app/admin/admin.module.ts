...
@NgModule({
  ...
  declarations: [
    ...
    AdminShopAddComponent,
    AdminShopEditComponent
  ],
  providers: [EmployeeGroupService, TreatmentTypeService, ShopService, CountryService, ProvinceService, ServiceTypeService],
